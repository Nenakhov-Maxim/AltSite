const menu_item_where_pay = document.querySelector('.footer-menu-wehere-pay-inner');

if (menu_item_where_pay) {
    menu_item_where_pay = menu_item_where_pay.querySelector('a')
